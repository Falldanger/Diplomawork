...
<html>
    ...
    <body>
        <div class="">
            ...
            <fieldset>
            <div class="result">
            <p><!-- Кнопка для вычисления и Поле для вывода результата --><span><b>До сплати: </b></span><output style="display: inline; font-weight: 600; color: #800000;" for="masa terytories period vud_zabrud source" name="pp"><b><span style="color: #800000;font-weight: 600;"> 3840 </span></b></output><span><b> грн.</b></span>
			</p>
            </div>
